...
import { FiShoppingCart } from "react-icons/fi"; // কার্ট আইকন ইম্পোর্ট করা হলো
      ...
      {cartItems.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <div className="w-24 h-24 bg-purple-50 rounded-full flex items-center justify-center mb-6">
            <FiShoppingCart className="text-5xl text-[#8B5CF6] opacity-50" />
          </div>
        ...
        <>
          ...
          <div className="flex justify-between items-center py-4 mb-4 border-t border-gray-100">
          ...
          <button
            ...
            className="w-full py-4 rounded-xl bg-[#8B5CF6] hover:bg-[#7C3AED] text-white font-bold text-lg transition-colors cursor-pointer active:scale-[0.98]"
          >
            Proceed To Checkout
          </button>
        </>
